...
gcc -g -c equijoins.c -o equijoins.o
gcc -g errhdl.o buffer.o crea.o table_info.o showtable.o where.o update.o delete.o insert.o des.o select_col.o select_where.o equijoins.o main.o
mv a.out ../test/
